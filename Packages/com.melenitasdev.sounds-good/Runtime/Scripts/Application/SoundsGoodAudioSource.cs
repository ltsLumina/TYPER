...
namespace MelenitasDev.SoundsGood
{
    ...
    internal partial class SoundsGoodAudioSource // Internal Methods
    {
        ...
        internal SoundsGoodAudioSource SetVolumeRolloffCurve (AudioRolloffMode audioRolloffMode, AnimationCurve customVolumeCurve)
        {
        ...
        internal SoundsGoodAudioSource SetPitch (float pitch)
        {
            source.pitch = pitch;
            return this;
        }
