...
class VIMenuItems
{
    ...
    public static bool cleanerHeaderEnabled
    {
        ...
        set
        {
            SetDefineDisabledInScript(typeof(VICleanerHeader), !value);
            EditorPrefs.SetBool("vInspector-hideScriptField", value);
            SetDefineDisabledInScript(typeof(VIResettablePropDrawer), !value);
        }
    }

    public static bool vInspectorDisabled
    {
    ...
    [MenuItem(disable, true, 1001)] static bool dadsadaadsdsddsaasadsas()
    {
        Menu.SetChecked(disable, vInspectorDisabled);
        return true;
    }
}
}
